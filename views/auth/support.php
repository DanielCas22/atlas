        ...
        <div class="col-md-6 col-lg-4">
            <div class="login-card">
                ...
                <p class="text-center mb-4" style="color: rgba(255,255,255,.75); font-size: 0.95rem; line-height: 1.4;">
                    Si tienes problemas para acceder o necesitas asistencia, comunícate con el administrador.
                </p>

                <div style="background: rgba(255,255,255,0.08); border-radius: 12px; padding: 20px; color: #fff;">
                    <p style="margin-bottom: 0.8rem; font-weight: 600;">Correo:</p>
                    ...
                    <p>Sábado: 7:00 am - 11:30 am</p>
                </div>

                <p class="signup" style="margin-top: 1.5rem; text-align: center;">
