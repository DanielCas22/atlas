...
if (empty($carpetas)) {
    ...
    if (empty($carpetas)) {
        $carpetas_manual = [
            // Empresas de ejemplo para demostrar funcionalidad
            'LISTADO ACME Security',
            'LISTADO XYZ Protection',
            'LISTADO Empresa ABC',
            'LISTADO Seguridad Total',
            'LISTADO Vigilancia Plus',
            'LISTADO Guardianes S.A.',
            'LISTADO Protección Integral',
            'LISTADO Seguridad Moderna',
        ];
